...
if uploaded_file is not None:
    ...
    if show_analysis:
        num_messeges, words, num_media_messages, url_count = helper.fetch_stats(selected_user, df)
        ...
        montly_timeline = helper.monthly_timeline(selected_user, df)
        fig,ax = plt.subplots()
        ax.plot(montly_timeline['time'], montly_timeline['message'], color='green')
